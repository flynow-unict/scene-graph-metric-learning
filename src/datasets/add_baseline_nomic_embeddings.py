...
input_dir = os.path.join(project_dir, "data", "sceneGraph", "raw", "full_set_baseline")
output_dir = os.path.join(project_dir, "data", "sceneGraph", "embedded", "full_set_baseline")
