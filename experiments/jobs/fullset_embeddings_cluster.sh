#!/bin/bash
#SBATCH --job-name=embeddings_full_set
...
echo "========================================="
echo "Avvio calcolo embeddings per il Full Set su nodo SLURM"
echo "========================================="
...
apptainer run --nv /shared/sifs/latest.sif python -u -m src.datasets.add_fullset_nomic_embeddings
