...
def main():
    ...
    print(f"⚙️  Validation set: {len(val_scene)} grafi (~10%)")
    print(f"🗄️  Test set (Gallery per FAISS): {len(test_gallery_scene)} grafi (~20%)")
    ...
    print("✅ Split sincronizzato completato con successo!")
